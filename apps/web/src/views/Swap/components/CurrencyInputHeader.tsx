    ...
    <Swap.CurrencyInputHeader
      title={
        <Flex width="100%" alignItems="center" >
          <Flex width="100%">
            <IconButton as={Link} href="https://docs.monad.xyz/getting-started/add-monad-to-wallet/metamask" variant="text" pt="10px" scale="sm">
            {t('Setup Guide 📑')}
            </IconButton>
          </Flex>
          ...
          <Flex width="100%" justifyContent="center">
            ...
            <IconButton as={Link} href="https://testnet.monad.xyz/" variant="text" scale="sm">
