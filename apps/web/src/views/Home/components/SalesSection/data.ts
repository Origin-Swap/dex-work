...
export const swapSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t(
    'OnlySwap is the first dex with an adequate UI for beginners. anyone can trade any token under OnlyLayer Blokchain.  ' +
  ...
  secondaryButton: {
    to: 'https://tektias.gitbook.io/tektias',
    text: t('Learn'),
    external: true,
  },
  images: {
    path: '/images/home/bridge/',
    attributes: [{ src: 'trading-a', alt: t('Pie chart') }],
  },
})
...
export const bridgeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  images: {
    path: '/images/home/bridge/',
    attributes: [{ src: 'earn', alt: t('Folder with cake token') }],
  },
})
