...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.MONAD_TESTNET]: '0x3Eaa09A9D8A00E519F2fb3EE0cE5A1B4ae76CA1C',
}
...
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0x365efc5C4Aef4b5b354C322585FE2aFc7794D258'

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'pancakeswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://tektias.gitbook.io/tektias'
